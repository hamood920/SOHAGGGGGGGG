...
public final class ReflectionUtils {
    ...
    public static void setValue(Object instance, String className, PackageType packageType, boolean declared,
                                String fieldName, Object value) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException,
            SecurityException, ClassNotFoundException {
    ...
    public enum PackageType {
        ...
        CRAFTBUKKIT_BLOCK(CRAFTBUKKIT.getPath() + "block"),
        CRAFTBUKKIT_CHUNKIO(CRAFTBUKKIT.getPath() + "chunkio"),
        CRAFTBUKKIT_COMMAND(CRAFTBUKKIT.getPath() + "command"),
        CRAFTBUKKIT_CONVERSATIONS(CRAFTBUKKIT.getPath() + "conversations"),
        CRAFTBUKKIT_ENCHANTMENS(CRAFTBUKKIT.getPath() + "enchantments"),
        CRAFTBUKKIT_ENTITY(CRAFTBUKKIT.getPath() + "entity"),
        CRAFTBUKKIT_EVENT(CRAFTBUKKIT.getPath() + "event"),
        CRAFTBUKKIT_GENERATOR(CRAFTBUKKIT.getPath() + "generator"),
        CRAFTBUKKIT_HELP(CRAFTBUKKIT.getPath() + "help"),
        CRAFTBUKKIT_INVENTORY(CRAFTBUKKIT.getPath() + "inventory"),
        CRAFTBUKKIT_MAP(CRAFTBUKKIT.getPath() + "map"),
        CRAFTBUKKIT_METADATA(CRAFTBUKKIT.getPath() + "metadata"),
        CRAFTBUKKIT_POTION(CRAFTBUKKIT.getPath() + "potion"),
        ...
        CRAFTBUKKIT_UPDATER(CRAFTBUKKIT.getPath() + "updater"),
        CRAFTBUKKIT_UTIL(CRAFTBUKKIT.getPath() + "util");
